:LATEX_SETTINGS:
#+EXPORT_FILE_NAME: bca-sujal-gurung-34-project2-report
...
# custom glossary style /w borders
# +LATEX_HEADER: \newglossarystyle{borderstyle}{%
# +LATEX_HEADER:   \setglossarystyle{list}%
# +LATEX_HEADER:   \renewcommand*{\glossaryentryfield}[5]{%
# +LATEX_HEADER:     \item \fbox{##2: ##3}%
# +LATEX_HEADER:   }%
# +LATEX_HEADER: }
...
% \printglossary[type=\acronymtype,title={List of Abbreviations},nopostdot,nonumberlist,style=borderstyle]
#+END_export
* Introduction
...
when we revise a card on that day, it isn't too hard nor is it too easy. As such, users only need to use CardsQL a little
