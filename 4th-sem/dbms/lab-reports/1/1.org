...
There are different implementations of relational databases in the form of Relational Database Management Systems. The overall syntax for sql commands is similar across them. For the purpose of this lab, we use Microsoft's =mssql=, also known as =SQL Server=.
