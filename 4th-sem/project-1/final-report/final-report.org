...
The project is explained across 5 major chapters in this report (excluding the *Appendix* and *References* at the end).
This section is part of [[*Introduction][_Chapter 1_]], which serves as an introduction to the project.

[[*Background Study and Literature Review][_Chapter 2_]] describes
some theories, scientific concepts, and an algorithm related to the project. It also includes an analysis of two similar
existing products. 
...
requirements and figuring out various designs for making CardsQL work.
...
- *Abstraction: User shouldn't have to understand how the algorithm works, or how cards are stored*
  #+LATEX:\\
  /Achieved by providing simple, intuitive GUI for all actions user should be able to do/
