...
|---+------+---------------------------------------------------------------+-----------------------+--------------+---------------------|
|   | S.N. | Test case                                                     | Input                 | Result       | Behave as expected? |
|---+------+---------------------------------------------------------------+-----------------------+--------------+---------------------|
| / |    < | <>                                                            | <>                    | <>           | <>                  |
...
I hope that students and other learners can study effectively through CardsQL and be able to retain what they learn for
...
programming concepts. As such, I am grateful to have completed this project as part of my coursework.
